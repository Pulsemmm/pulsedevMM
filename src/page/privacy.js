...
const Privacy = () => {
  return (
    <div>
      <div className="privacy d-flex v-center h-center flex-column">
        <div className="content d-flex flex-column">
          <h1>
            PRIVACY POLICY <br /> PULSE MARKETING INC.
          </h1>
          <p className="mt-5">
        ...
        <div className="defination d-flex flex-column">
          <h3>Deﬁnitions</h3>
          <p>
          ...
          <p>
            ...
            Agreement) refers to Pulse Marketing Inc., 595 Burrard Street,
            Vancouver, BC V7X 1L4, Canada.
          </p>
          <p>
            Cookies are small ﬁles that are placed on Your computer, mobile
          ...
          <p>
            ...
            information that relates to an identiﬁed or identiﬁable individual.
          </p>
        </div>
        <div className="defination d-flex flex-column">
          <h3>Service strong refers to the Website</h3>
          <p>
        ...
        <div className="defination d-flex flex-column">
          <h3>
            Website refers to Pulse Marketing Inc., accessible from
            pulsemarketing.io.
          </h3>
          <p>
          ...
          <p>
            ...
            with certain personally identiﬁable information that can be used to
            contact or identify You. Personally identiﬁable information may
            ...
            those pages, unique device identiﬁers and other diagnostic data.
          </p>
          <p>
            ...
            unique device identiﬁers and other diagnostic data. We may also
          ...
          <p>
            Information from Third-Party Social Media Services The Company
            allows You to create an account and log in to use the Service
            through the following Third-party Social Media Services: Google
            Facebook Twitter If You decide to register through or otherwise
            grant us access to a Third-Party Social Media Service, We may
          ...
          <p>
            ...
            analyze Our Service. The technologies We use may include: Cookies or
            Browser Cookies. A cookie is a small ﬁle placed on Your Device. You
          ...
          <p>
            ...
            may contain small electronic ﬁles known as web beacons (also
            ...
            section and verifying system and server integrity). Cookies can be
            Persistent; Session; Cookies. Persistent Cookies remain on Your
            personal computer or mobile device when You go ofﬂine, while Session
            Cookies are deleted as soon as You close Your web browser. You can
            learn more about cookies here: All About Cookies by TermsFeed We use
        ...
        <div className="defination d-flex flex-column">
          ...
          <p>
            ...
            application’s push notiﬁcations regarding updates or informative
        ...
        <div className="defination d-flex flex-column">
          <h3>Affiliates</h3>
          <p>
            We may share Your information with Our afﬁliates, in which case we
            will require those afﬁliates to honour this Privacy Policy.
            Afﬁliates include Our parent company and any other subsidiaries,
          ...
          <p>
            ...
            Third-Party Social Media Service may see Your name, proﬁle, pictures
          ...
          <p>
            ...
            Data, is processed at the Company’s operating ofﬁces and in any
          ...
          <p>
            ...
            or the public Protect against legal liability.
          </p>
          <p>
          ...
          <p>
            ...
            of 13. We do not knowingly collect personally identiﬁable
            ...
            veriﬁcation of parental consent, We take steps to remove that
          ...
          <p>
            ...
            can contact us: By email: hi@pulsemarketing.io. By visiting this
            page on our website: www.pulsemarketing.io/contact
          </p>
        </div>
      </div>
    </div>
